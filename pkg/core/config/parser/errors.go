...
// All errors are defined using the errs package for enhanced tracking and observability.
package parser
...
var (
	...
	ErrInvalidExtension = errs.Define(errs.KConfig{
		Code:    1001,
	...
	ErrFileNotFound = errs.Define(errs.KConfig{
		Code:    1002,
	...
	ErrReadFailed = errs.Define(errs.KConfig{
		Code:    1003,
	...
	ErrJSONParse = errs.Define(errs.KConfig{
		Code:    1010,
	...
	ErrYAMLParse = errs.Define(errs.KConfig{
		Code:    1020,
	...
	ErrTOMLParse = errs.Define(errs.KConfig{
		Code:    1030,
	...
	ErrXMLParse = errs.Define(errs.KConfig{
		Code:    1040,
	...
	ErrINIParse = errs.Define(errs.KConfig{
		Code:    1050,
	...
	ErrENVParse = errs.Define(errs.KConfig{
		Code:    1060,
	...
	ErrARGSParse = errs.Define(errs.KConfig{
		Code:    1070,
	...
	ErrARGSInvalid = errs.Define(errs.KConfig{
		Code:    1071,
