...
// BenchmarkNodePool benchmarks node pool operations
...
// =============================================================================
// Global Cache Benchmarks
// =============================================================================

// BenchmarkGlobalCache benchmarks global cache operations
func BenchmarkGlobalCache(b *testing.B) {
	// Configure global cache before first use
	ConfigureGlobal(10000, 16, true)
	global := Global()
	...
	b.Run("GlobalHas", func(b *testing.B) {
		// Pre-populate
		for i := 0; i < 1000; i++ {
			global.Set(i, i*2)
		}
