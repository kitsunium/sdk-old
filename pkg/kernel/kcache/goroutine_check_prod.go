...
// for kernel-level operations. This file contains the production build version
// of goroutine checking (disabled). When the unsafe_no_check build tag is used,
// all safety checks become no-ops for maximum performance in production.
package kcache
