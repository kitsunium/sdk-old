...
func TestAtomicCache_NewAtomicCache(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			c := cache.NewAtomicCache[string, int](tt.capacity)
			assert.NotNil(t, c)
...
func TestAtomicCache_BasicOperations(t *testing.T) {
	c := cache.NewAtomicCache[string, int](100)
...
func TestAtomicCache_Eviction(t *testing.T) {
	c := cache.NewAtomicCache[int, int](10)
...
func TestAtomicCache_BatchSetWithEviction(t *testing.T) {
	c := cache.NewAtomicCache[string, int](5)
...
func TestAtomicCache_ConcurrentAccess(t *testing.T) {
	c := cache.NewAtomicCache[int, int](1000)
...
func TestAtomicCache_Interface(t *testing.T) {
	var c cache.Cache[string, int] = cache.NewAtomicCache[string, int](100)
	require.NotNil(t, c)
