...
var (
	...
	ErrJSONParse = errs.Define(errs.Config{
		Code:    1010,
	...
	ErrYAMLParse = errs.Define(errs.Config{
		Code:    1020,
	...
	ErrTOMLParse = errs.Define(errs.Config{
		Code:    1030,
	...
	ErrXMLParse = errs.Define(errs.Config{
		Code:    1040,
	...
	ErrINIParse = errs.Define(errs.Config{
		Code:    1050,
	...
	ErrENVParse = errs.Define(errs.Config{
		Code:    1060,
