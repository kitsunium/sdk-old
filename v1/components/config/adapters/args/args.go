// Package args implements a Parser adapter reading command-line
// arguments. Supports both --key=value and --key value formats plus
// single-dash shorthands; normalizes keys to the canonical dot-path
// form.
package args
