// Package env implements a Parser adapter reading environment
// variables. It can optionally filter by prefix (APP_, etc.) and
// normalizes keys to the canonical dot-path form.
package env
