...
import (
	...
	"github.com/kitsunium/sdk/v1/internal/kernel/files"
...
func TestStats(t *testing.T) {
	...
	t.Run("IsFile", func(t *testing.T) {
		t.Run("Nominal", func(t *testing.T) {
			...
			s := files.NewStats(tempFile.Name())
			if !s.IsFile() {
	...
	t.Run("IsDirectory", func(t *testing.T) {
		...
		t.Run("EdgeCase", func(t *testing.T) {
			sFile := files.NewStats("/nonexistent")
	...
	t.Run("Exists", func(t *testing.T) {
		...
		t.Run("EdgeCase", func(t *testing.T) {
			sNonExistent := files.NewStats("/non/existent/path")
